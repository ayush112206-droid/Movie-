...
export default function TVShowsPage() {
  ...
  const { data, size, setSize, isLoading } = useTMDBInfinite('discover/tv', params);

  const shows = data ? data.map(page => page.results || []).flat() : [];
    ...
    <main className="min-h-screen pb-24">
      ...
      <div className="container mx-auto px-4 md:px-8 pt-28 space-y-8">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div>
            <h1 className="text-3xl font-[900] text-white">TV Shows</h1>
            <p className="text-text-3 text-sm mt-1">Binge-worthy series from across the globe.</p>
          </div>
